...
public class litcoin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_litcoin);
        ...
        copyI.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(litcoin.this, "copied", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        closedep.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(litcoin.this, cryptodeposit.class);
